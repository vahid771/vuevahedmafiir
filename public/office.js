    ...
    var a = false,
        ...
        c = function() {
            ...
            function f(b) {
                ...
                a.basePath = c;
                a.getUseAssociatedActionsOnly = c
            }
            ...
            f.prototype.getOfficeJsBasePath = function() {
                var b = this;
                if (b.basePath) return b.basePath;
                else {
                    var h = function(b, c) {
                            var d, a, e;
                            e = b.toLowerCase();
                        ...
                        i = d.length,
                        f = [b.constantNames.OfficeJS, b.constantNames.OfficeDebugJS],
                        g = f.length;
                    b.getUseAssociatedActionsOnly = a;
                    for (var e, c = 0; !b.basePath && c < i; c++)
                        if (d[c].src)
                            for (e = 0; !b.basePath && e < g; e++) {
                                b.basePath = h(d[c].src, f[e]);
                                if (b.basePath) try {
                                    var j = d[c].getAttribute("data-use-associated-actions-only");
                                    b.getUseAssociatedActionsOnly = j === "1"
                                } catch (k) {}
                            }
                    return b.basePath
                }
